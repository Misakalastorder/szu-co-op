#!/usr/bin/env python3
import time,json,random,sys,os,threading,math,signal,ctypes
...
class LinkerHandL21For485:
    def __init__(self,ip="192.168.10.19", linkerhand_id=40, modbus_port = 1,modbus_baudrate = 115200,modbus_timeout = 5):
        '''
        初始化睿尔曼485接口
        :params
        arm: 初始化的睿尔曼机械臂
    ...
    def set_speed(self, speed=[120,200,200,200,200]):
        ...
        self.handle = self.arm.rm_create_robot_arm("192.168.10.19", 8080,0)
        print("*" * 20)
